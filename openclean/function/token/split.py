...
class ChartypeSplit(StringTokenizer):
    ...
    """
    def __init__(self, chartypes: List[Callable]):
        """Initialize the character type classifier.

        Parameters
        ----------
        chartypes: list of callable
            List of functions that are used to determine the type of a character.
            The functins are applied in the given order. The first function that
            returns True for given character defines the character type.
        """
        self.chartypes = chartypes
...
class Split(StringTokenizer):
    ...
    method. Defines a extra parameters to modify the generated token lists.
    ...
    def __init__(
        ...
        subtokens: Optional[StringTokenizer] = None
    ):
