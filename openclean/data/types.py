...
"""Definition of aliases of data types that are composed of the basic types
fro data frames.
"""

from typing import List, Union

from openclean.data.column import ColumnSet
...
Columns = Union[ColumnSet, List[Union[int, str]], int, str]
